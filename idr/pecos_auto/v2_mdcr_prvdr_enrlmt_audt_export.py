...
class V2MdcrPrvdrEnrlmtAudtExporter(IDROutputter):
    ...
    def getSelectQuery(self) -> str:
        ...
        return """SELECT
                ...
                PRVDR_ENRLMT_UPDT_DT, -- DATE: DATE DATA CORRECTED
                ...
                PRVDR_ENRLMT_CNTRCTR_ID, -- TEXT(20): UNIQUE NUMBER THAT IDENTIFIES A MEDICARE CONTRACTOR.
                PRVDR_ENRLMT_SPCLTY_CD, -- TEXT(20): A CODE IDENTIFYING THE CENTERS FOR MEDICARE AND MEDICAID SERVICES (CMS) SPECIALTY OF A PROVIDER OR SUPPLIER.  FOR EXAMPLE:  11 = INTERNAL MEDICINE  49 = AMBULATORY SURGICAL CENTER    REFERENCE TABLE: CLM_PRVDR_SPCLTY_CD
                ...
                PRVDR_ENRLMT_SPCLTY_EFCTV_DT, -- DATE: DATE THE RECORD WAS CREATED (MM/DD/YYYY)
