...
class V2MdcdPrvdrEnrlmtMthdCdExporter(IDROutputter):
    ...
    def getSelectQuery(self) -> str:
        ...
        """
        return """SELECT
                PRVDR_MDCD_ENRLMT_MTHD_CD, -- TEXT(1): A CODE THAT IDENTIFIES THE SOURCE SYSTEM USED TO DESIGNATE THE PROVIDERS ENROLLMENT IN MEDICAID OR CHILDRENS HEALTH INSURANCE PROGRAM (CHIP).
                PRVDR_MDCD_ENRLMT_MTHD_DESC, -- TEXT(500): A DESCRIPTION OF THE CODE THAT IDENTIFIES THE SOURCE SYSTEM USED TO DESIGNATE THE PROVIDERS ENROLLMENT IN MEDICAID OR CHILDRENS HEALTH INSURANCE PROGRAM (CHIP).
