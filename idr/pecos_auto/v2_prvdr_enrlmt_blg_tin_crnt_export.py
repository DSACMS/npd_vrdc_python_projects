...
N = PROVIDER TIN END DATE IS NOT DERIVED
                PRVDR_TIN_TYPE_CD, -- TEXT(1): A CODE IDENTIFYING THE BILLING TAXPAYER IDENTIFICATION TYPE FOR A PROVIDER WHO HAS ENROLLED IN THE PROVIDER ENROLLMENT, CHAIN, AND OWNERSHIP SYSTEM (PECOS).

VALID VALUES:
E = EMPLOYEE IDENTIFICATION NUMBER
S = SOCIAL SECURITY NUMBER
                PRVDR_ENRLMT_BLG_TIN_STRUC_CD, -- TEXT(2): A CODE IDENTIFYING THE BILLING TAXPAYER IDENTIFICATION STRUCTURE TYPE FOR A PROVIDER WHO HAS ENROLLED IN THE PROVIDER ENROLLMENT, CHAIN, AND OWNERSHIP SYSTEM (PECOS).
