...
class V2MdcrPrvdrEnrlmtExporter(IDROutputter):
    ...
    def getSelectQuery(self) -> str:
        ...
        return """SELECT
                ...
                PRVDR_PAC_ID, -- TEXT(10): THE SYSTEM GENERATED PECOS ASSOCIATE CONTROL ID.
                ...
                PRVDR_ENRLMT_MLG_LINE_2_ADR, -- TEXT(55): LINE 2 OF PECOS ASSOCIATE MAILING ADDRESS.
                GEO_SK, -- NUMBER(38): AN INTEGRATED DATA REPOSITORY (IDR) ASSIGNED NUMERIC SURROGATE KEY IDENTIFYING A PARTICULAR GEOGRAPHICAL LOCATION BY ITS FIVE-DIGIT ZIP CODE.
                ...
                PRVDR_ENRLMT_INVLD_PLC_NAME, -- TEXT(30): PLACE NAME OF MAILING ADDRESS. POPULATED ONLY WHEN THE PLACE NAME SUPPLIED BY THE PECOS SYSTEM DIFFERS FROM THE PLACE NAME ASSOCIATED WITH THE CORRESPONDING ZIP CODE IN THE AUTHORITATIVE SOURCE FOR ZIP CODE DATA. PECOS IS NOT THE AUTHORITATIVE SOURCE OF
                PRVDR_ENRLMT_INVLD_STATE_CD, -- TEXT(2): UNIQUE VALUE THAT IDENTIFIES A STATE. STATE CODE OF MAILING ADDRESS. POPULATED ONLY WHEN THE STATE CODE SUPPLIED BY THE PECOS SYSTEM DIFFERS FROM THE PLACE NAME ASSOCIATED WITH THE CORRESPONDING ZIP CODE IN THE AUTHORITATIVE SOURCE FOR ZIP CODE DATA. PECOS IS NOT THE AUTHORITATIVE SOURCE OF ZIP CODE DATA.
                PRVDR_ENRLMT_INVLD_ZIP_CD, -- TEXT(9): ZIP CODE FOR ENROLLMENT ADDRESS. INVALID ZIP CODE ON ENROLLMENT RECORD. POPULATED FROM THE SOURCE WHEN INCONSISTENT WITH THE GEOGRAPHY DATA FOR THE ZIP CODE.
                PRVDR_ENRLMT_FRGN_STATE_NAME, -- TEXT(30): NAME OF STATE USED WITH FOREIGN ADDRESS.
                PRVDR_ENRLMT_FRGN_PSTL_CD, -- TEXT(15): POSTAL CODE ASSOCIATED WITH FOREIGN CORRESPONDENCE ADDRESSES.
                PRVDR_ENRLMT_CNTRY_NAME, -- TEXT(30): OFFICIAL SHORT NAME OF A COUNTRY IN ENGLISH.
                ...
                PRVDR_ENRLMT_DEATH_DT, -- DATE: PECOS ASSOCIATES DATE OF DEATH. THIS DATA ELEMENT IS NOT CAPTURED ON ANY 855 FORM. ITS CAPTURES FROM THE APPROVED PENDING UPIN PROCESS.
                PRVDR_ENRLMT_FORM_TYPE_CD, -- TEXT(2): UNIQUE VALUE THAT IDENTIFIES THE TYPE OF ENROLLMENT FORM. THE TYPES MAY BE A 855R, 855C, ETC.
                PRVDR_ENRLMT_FRGN_ADR_IND, -- TEXT(1): INDICATES WHETHER THE ADDRESS IS A FOREIGN ADDRESS.
                PRVDR_ENRLMT_GRDTN_YR_NUM, -- NUMBER(4): THE YEAR THE INDIVIDUAL PRACTITIONER GRADUATED FROM MEDICAL SCHOOL.
                PRVDR_ENRLMT_MDCL_SCHL_ID, -- TEXT(5): UNIQUE MEDICAL SCHOOL CODE. EXHIBIT 3A OF THE PHYSICIAN IDENTIFICATION AND REGISTRATION DOCUMENT LISTS THE MEDICAL SCHOOL CODES.
                PRVDR_ENRLMT_MDL_NAME, -- TEXT(25): MIDDLE NAME OF PECOS ASSOCIATE.
                PRVDR_ENRLMT_PRVDR_TYPE_CD, -- TEXT(2): UNIQUE VALUE THAT IDENTIFIES A FACILITY TYPE.
                ...
                PRVDR_ENRLMT_SUPLR_TYPE_CD -- TEXT(2): UNIQUE VALUE THAT IDENTIFIES THE TYPE OF SERVICE THE SUPPLIER WILL PROVIDE. E.G., AMBULANCE SERVICE , DIAGNOSTIC RADIOLOGY PRACTICE, MASS IMMUNIZATION. ETC..
