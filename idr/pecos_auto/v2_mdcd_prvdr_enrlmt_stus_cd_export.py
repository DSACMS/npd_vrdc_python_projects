...
class V2MdcdPrvdrEnrlmtStusCdExporter(IDROutputter):
    ...
    def getSelectQuery(self) -> str:
        ...
        """
        return """SELECT
                PRVDR_MDCD_ENRLMT_STUS_CD, -- TEXT(2): A CODE REPRESENTING THE STATUS OF THE PROVIDERÒ² ENROLLMENT IN THE MEDICAID OR CHILDRENS HEALTH INSURANCE PROGRAM (CHIP) PLAN.
                PRVDR_MDCD_ENRLMT_STUS_DESC, -- TEXT(500): A DESCRIPTION OF THE CODE REPRESENTING THE STATUS OF THE PROVIDERÒ² ENROLLMENT IN THE MEDICAID OR CHILDRENS HEALTH INSURANCE PROGRAM (CHIP) PLAN.
