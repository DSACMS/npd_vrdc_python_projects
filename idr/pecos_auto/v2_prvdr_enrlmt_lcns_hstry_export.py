...
class V2PrvdrEnrlmtLcnsHstryExporter(IDROutputter):
    ...
    def getSelectQuery(self) -> str:
        ...
        return """SELECT
                ...
                PRVDR_ENRLMT_LCNS_STATE_CD, -- TEXT(2): A UNIQUE VALUE THAT IDENTIFIES THE STATE THE LICENSE WAS ISSUED IN. REFERENCE TABLE: GEO_USPS_STATE_CD
                PRVDR_ENRLMT_LCNS_NUM, -- TEXT(20): AN IDENTIFIER ASSIGNED BY THE STATE'S MEDICAL BOARD TO A MEDICAL PROFESSIONAL THAT ALLOWS THEM TO PRACTICE MEDICINE WITHIN THAT STATE.
                PRVDR_ENRLMT_LCNS_EFCTV_DT, -- DATE: DATE WHEN THE LICENSE WAS EFFECTIVE FOR THE INDICATED STATE.
