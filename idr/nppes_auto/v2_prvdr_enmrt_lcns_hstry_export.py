...
class V2PrvdrEnmrtLcnsHstryExporter(IDROutputter):
    ...
    def getSelectQuery(self) -> str:
        ...
        return """SELECT
                ...
                PRVDR_LCNS_NUM, -- TEXT(20): A NUMBER ASSIGNED BY A STATE OR TERRITORY TO AN INDIVIDUAL PROVIDER CERTIFYING THE PERSONS ABILITY TO PRACTICE MEDICINE WITHIN A RANGE OF SPECIALIZATIONS.
                PRVDR_LCNS_USPS_STATE_CD, -- TEXT(2): A CODE IDENTIFYING THE TWO-CHARACTER UNITED STATES POSTAL SERVICE (USPS) ALPHABETIC ABBREVIATION FOR THE ISSUING STATE OF THE LICENSE NUMBER.      REFERENCE TABLE:  GEO_USPS_STATE_CD
