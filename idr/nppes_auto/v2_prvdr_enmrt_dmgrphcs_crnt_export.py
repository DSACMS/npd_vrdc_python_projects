...
class V2PrvdrEnmrtDmgrphcsCrntExporter(IDROutputter):
    ...
    def getSelectQuery(self) -> str:
        ...
        return """SELECT
                ...
                PRVDR_ENT_TYPE_CD, -- TEXT(1): A CODE THAT IDENTIFIES THE PROVIDER'S BUSINESS STRUCTURE.
...
'2' = ORGANIZATION
                ...
                PRVDR_DEACTVTN_RSN_CD, -- TEXT(2): A CODE REPRESENTING THE REASON THE NATIONAL PLAN AND PROVIDER ENUMERATION SYSTEM (NPPES) DEACTIVATED A PROVIDER RECORD.
...
REFERENCE TABLE:  PRVDR_DEACTVTN_RSN_CD
                ...
                PRVDR_GNDR_CD, -- TEXT(1): AN IDENTIFIER DESCRIBING THE SEX OF THE PROVIDER.

VALID VALUES:
'M' = MALE 
'F' = FEMALE
                PRVDR_BIRTH_DT, -- DATE: A DATE OF BIRTH OF A PROVIDER.
                PRVDR_BIRTH_USPS_STATE_CD, -- TEXT(2): A CODE IDENTIFYING THE TWO-CHARACTER UNITED STATES POSTAL SERVICE (USPS) ALPHABETIC ABBREVIATION FOR THE STATE THE PROVIDER WAS BORN IN.

REFERENCE TABLE: GEO_USPS_STATE_CD  
                PRVDR_BIRTH_CNTRY_CD, -- TEXT(2): A  TWO-CHARACTER ALPHABETIC ABBREVIATION OF THE COUNTRY WHERE THE HEALTH CARE PROVIDER WAS BORN. IT WILL ONLY BE POPULATED FOR INDIVIDUAL PROVIDERS (PROVIDER ENTITY TYPE CODE = 1).

REFERENCE TABLE:  GEO_CNTRY_CD
                PRVDR_SOLE_PRPRTR_CD, -- TEXT(1): A CODE INDICATING IF A TYPE 1 PROVIDER (INDIVIDUAL) IS THE SOLE PROPRIETOR.
VALID VALUES:
Y = YES, ENTITY TYPE 1 PROVIDER (INDIVIDUAL) IS A SOLE PROPRIETOR 
N = NO, ENTITY TYPE 1 PROVIDER (INDIVIDUAL) IS NOT A SOLE PROPRIETOR 
X = NOT ANSWERED
                PRVDR_ORG_SUBRDNT_CD, -- TEXT(1): A CODE IDENTIFYING IF A PROVIDER IS A SUBPART OF A HEALTH CARE ORGANIZATION (I.E., ENTITY TYPE 2).

VALID VALUES:
Y = YES, ENTITY TYPE 2 PROVIDER (ORGANIZATION) IS A SUBPART 
N = NO, ENTITY TYPE 2 PROVIDER (ORGANIZATION) IS NOT A SUBPART 
X = NOT ANSWERED
                PRVDR_PRNT_ORG_TIN_NUM, -- TEXT(9): A UNIQUE  TAX IDENTIFIER ASSIGNED TO A HEALTH CARE PROVIDER BY SOCIAL SECURITY ADMINISTRATION (SSA) OR THE INTERNAL
REVENUE SERVICE (IRS).
                ...
                MLG_GEO_USPS_STATE_CD, -- TEXT(2): A CODE IDENTIFYING A TWO-CHARACTER ALPHABETIC ABBREVIATION FOR A STATE IN THE UNITED STATES AS DEFINED BY UNITED STATES POSTAL SERVICE (USPS) ASSOCIATED WITH A BENEFICIARY, PROVIDER, OR CLAIM ADDRESS.

REFERENCE TABLE:  GEO_USPS_STATE_CD
                MLG_GEO_ZIP5_CD, -- TEXT(5): A FIVE-DIGIT ZIP CODE DEFINED BY THE UNITED STATES POSTAL SERVICE (USPS) THAT IDENTIFIES A DESTINATION POST OFFICE OR  DELIVERY AREA ASSOCIATED WITH A BENEFICIARY, PROVIDER, OR CLAIM ADDRESS.

REFERENCE TABLE:  GEO_ZIP5_CD
                MLG_GEO_ZIP4_CD, -- TEXT(4): A FOUR-DIGIT ZIP CODE EXTENSION DEFINED BY THE UNITED STATES POSTAL SERVICE (USPS) THAT REPRESENTS A SPECIFIC DELIVERY ROUTE WITHIN A DELIVERY AREA ASSOCIATED WITH A BENEFICIARY, PROVIDER, OR CLAIM ADDRESS.
...
REFERENCE TABLE:  GEO_ZIP9_CD
                ...
                MLG_CNTRY_CD, -- TEXT(2): A CODE IDENTIFYING A COUNTRY ASSOCIATED WITH A BENEFICIARY, PROVIDER, OR CLAIM ADDRESS AS ASSIGNED BY THE INTERNATIONAL ORGANIZATION FOR STANDARDIZATION (ISO).
...
REFERENCE TABLE: GEO_CNTRY_CD
                ...
                PRCTC_GEO_USPS_STATE_CD, -- TEXT(2): A CODE IDENTIFYING A TWO-CHARACTER ALPHABETIC ABBREVIATION FOR A STATE IN THE UNITED STATES AS DEFINED BY UNITED STATES POSTAL SERVICE (USPS) ASSOCIATED WITH A BENEFICIARY, PROVIDER, OR CLAIM ADDRESS.
...
REFERENCE TABLE:  GEO_USPS_STATE_CD
                ...
                PRCTC_GEO_ZIP4_CD, -- TEXT(4): A FOUR-DIGIT ZIP CODE EXTENSION DEFINED BY THE UNITED STATES POSTAL SERVICE (USPS) THAT REPRESENTS A SPECIFIC DELIVERY ROUTE WITHIN A DELIVERY AREA ASSOCIATED WITH A BENEFICIARY, PROVIDER, OR CLAIM ADDRESS AND USED IN THE GEOCODING PROCESS.
...
REFERENCE TABLE: GEO_ZIP9_CD
                ...
                PRCTC_CNTRY_CD, -- TEXT(2): A TWO-CHARACTER ALPHABETIC ABBREVIATION OF THE COUNTRY ASSOCIATED WITH A BENEFICIARY, PROVIDER, OR CLAIM ADDRESS. 
